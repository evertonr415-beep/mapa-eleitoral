(function(){
  'use strict';
  if(window.__vfMobileCollegeGridLoaded)return;
  window.__vfMobileCollegeGridLoaded=true;
  ...
  function install(){
    ...
    if(!select.dataset.vfMobileCollegeGridBound){
      select.dataset.vfMobileCollegeGridBound='1';
    ...
    if(tbody&&!tbody.dataset.vfMobileCollegeGridObserved){
      tbody.dataset.vfMobileCollegeGridObserved='1';
  ...
  window.addEventListener('resize',function(){schedule(80);});
}());