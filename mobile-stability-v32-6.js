(function(){
  'use strict';
  if(window.__vfMobileStabilityV331)return;
  window.__vfMobileStabilityV331=true;
  ...
  function ensureCandidateSupport(){
    ...
    loadOnce(location.origin+'/leadership-electors-v38.js?v=38','vf-leadership-electors-v38');
  }
